 ...
 */
  ...
  addBreakPoint: async function(lineNumber) {
    await driver.wait(until.elementLocated(By.xpath('//*[@id="code-editor-opener:file:///projects/apd-sample/sample-applications/phm_examples/phm_demo/src/application.cpp"]/div/div[1]/div[1]/div[3]/div[16]/div')), 7000).getText().then(el=>{
